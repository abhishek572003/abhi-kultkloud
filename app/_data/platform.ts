...
export const platformItems: ContentItem[] = [
  ...
  { slug: "terraform-networking", type: "Lab", title: "Terraform VPC baseline", description: "A portfolio lab for expressing a small AWS network as code and explaining each decision.", topics: ["Terraform", "AWS", "VPC"], level: "Intermediate", time: "2 hrs", href: "/labs/terraform-vpc" },
  { slug: "serverless-flow", type: "Project", title: "Serverless request flow", description: "Trace a request through a static frontend, authenticated API, function, and managed persistence layer.", topics: ["AWS", "Serverless"], level: "Intermediate", time: "2 hrs", href: "/projects/serverless-request-flow" },
];
